...
function StatisticsSection() {
  return (
    <div className='flex w-full  lg:px-24 my-10'>
      <div className=' flex w-full bg-green-100 p-10 justify-between rounded-md'>
        <div className='flex items-center gap-6'>
          <div className=' p-8 bg-white'>
            <VscBook size={60} className=' text-blue-400' />
          </div>
          <div className='flex flex-col gap-4'>
            <h1 className=' text-6xl text-green-600 font-bold'>10K+</h1>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='flex flex-col gap-4'>
            <h1 className=' text-6xl text-green-600 font-bold'>500+</h1>
        ...
        <div className='flex items-center gap-6'>
          ...
          <div className='flex flex-col gap-4'>
            <h1 className=' text-6xl text-green-600 font-bold'>300K+</h1>
